...
export default function AccordionList() {
    ...
    // Seleziona di default il primo linguaggio disponibile
        ...
        <div>
            ...
            <div className="button-container">
                ...
                {languages.map(language => (
                    ...
                    <button
                        key={language.id}
                        className={`button ${selectedId === language.id ? "active" : ""}`}
            ...
            <Accordion
                titolo={languages.find(lang => lang.id === selectedId)?.title}
                descrizione={languages.find(lang => lang.id === selectedId)?.description}
